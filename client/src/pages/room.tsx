...
const Room: React.FC = () => {
  ...
  useEffect(()=>{
    ...
    //event is fired when a message is received from the server
    newSocket.onmessage = (message) => {
      ...
      if (parsedMessage.Title === "Room-Info") {
        ...
        setSubmitClicked(false)
        alert("Code cannot be processed now cause it requires a continuously running worker service which is expensive 😅😅, if you want to, you can clone the repo and run worker process locally!!")
      }
    }
    setSocket(newSocket)
    ...
    <Flex h="100vh" color="blue.200">
      ...
      <Flex direction="column" bg="gray.900" flex="1" width={useBreakpointValue({ base: '100vh', md: '80vh', sm: '60vh' })} >
        ...
        <Flex bg="gray.800" p="4" justify="center" align="center" position="relative" direction="column">
          ...
          <Flex align="center" justify="center">
            <Box color="blue.500" fontWeight="bold" ml="4" mt="4">
              {roomName}
            </Box>
          </Flex>
        ...
        <Flex flex="1" p="2" align="center" justify="center">
            ...
            <CodeMirror 
              ...
              height={useBreakpointValue({ base: '90vh', lg:"70vh", md: '60vh', sm: '70vh' })} 
              width={useBreakpointValue({ base: '100vh', lg:"90vh", md: '70vh', sm: '80vh' })} 
